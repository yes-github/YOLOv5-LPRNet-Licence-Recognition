...
if __name__ == "__main__":
    ...
    # det标记文件目录
    label_base_dir = "Z:/CCPD/det/labels"
    train_txt_path = os.path.join(label_base_dir, "train")
    val_txt_path = os.path.join(label_base_dir, "val")
    test_txt_path = os.path.join(label_base_dir, "test")

    # 删除目录
    shutil.rmtree(label_base_dir, ignore_errors=True)
