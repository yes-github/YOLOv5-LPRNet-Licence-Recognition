...
def ccpd2lpr(input_dir, output_dir):
    ...
    for filename in os.listdir(input_dir):
        ...
        result += (
            ads[int(list_plate[2])]
            + ads[int(list_plate[3])]
            + ads[int(list_plate[4])]
            + ads[int(list_plate[5])]
        ...
        cv2.imencode(".jpg", img)[1].tofile(
            os.path.join(output_dir, "{}.jpg".format(result))
        )
        # 图片中文名会报错
...
if __name__ == "__main__":
    # ccpd2lpr(
    #     "/home/ye/CODE/MY/YOLOv5-LPRNet-Licence-Recognition/tmp/datasets/ccpd/raw/val",
    #     "/home/ye/CODE/MY/YOLOv5-LPRNet-Licence-Recognition/tmp/datasets/ccpd/rec/val",
    # )

    # ccpd2lpr(
    #     "/home/ye/CODE/MY/YOLOv5-LPRNet-Licence-Recognition/tmp/datasets/ccpd/raw/test",
    #     "/home/ye/CODE/MY/YOLOv5-LPRNet-Licence-Recognition/tmp/datasets/ccpd/rec/test",
    # )

    ccpd2lpr(
        "/home/ye/CODE/MY/YOLOv5-LPRNet-Licence-Recognition/tmp/datasets/ccpd/raw/train",
        "/home/ye/CODE/MY/YOLOv5-LPRNet-Licence-Recognition/tmp/datasets/ccpd/rec/train",
    )
