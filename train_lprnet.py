...
def train():
    ...
    torch.save(lprnet.state_dict(), args.save_folder + "/lprnet-last.pth")
...
def get_parser():
    ...
    parser.add_argument(
        "--train_img_dirs", default="Z:/CCPD/rec/train", help="the train images path"
    )
    parser.add_argument(
        "--test_img_dirs", default="Z:/CCPD/rec/val", help="the test images path"
    )
    ...
    parser.add_argument(
        "--lpr_max_len", default=8, help="license plate number max length."
    )
    ...
    parser.add_argument(
        "--save_folder", default="./runs", help="Location to save checkpoint models"
    )
